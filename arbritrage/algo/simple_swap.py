...
quote_CHOICE_ALGO = CHOICE_ALGO.fetch_fixed_input_swap_quote(CHOICE(100), slippage=0.001)
tx_CHOICE_ALGO = CHOICE_ALGO.prepare_swap_transactions_from_quote(quote_CHOICE_ALGO)
