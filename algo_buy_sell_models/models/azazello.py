...
class azazello:
    ...
    def add_tengu(self, asset1_id, asset2_id, swapmin=0, swapmax=500, alpha=0.015, beta=0.020, gamma=0.600):
...
class tengu:
    ...
    def __init__(self,
        ...
        self.a1toa2_baseline = a1a2bl
        self.a2toa1_baseline = a2a1bl
    ...
    def update(self,
        ...
        # Update Rates
        self.usdc_to_a1 = usdctoa1
        self.usdc_to_a2 = usdctoa2
        self.a1toa2_current = a1toa2
        self.a2toa1_current = a2toa1
        ...
        self.swapforward = 0
        heaviside_forward = self.heaviside(self.a1toa2_baseline_change)
        logistic_forward = self.modified_logistic(self.a1toa2_baseline_change)
        minswap_forward = self.swapmin * self.usdc_to_a1
        self.swapforward = heaviside_forward * logistic_forward * (self.swapmax * self.usdc_to_a1)
        if self.swapforward < minswap_forward or a1_available < self.swapforward: self.swapforward = 0

        # Calculate Backward Swap
        self.swapbackward = 0
        heaviside_backward = self.heaviside(self.a2toa1_baseline_change)
        logistic_backward = self.modified_logistic(self.a2toa1_baseline_change)
        minswap_backward = self.swapmin * self.usdc_to_a2
        self.swapbackward = heaviside_backward * logistic_backward * (self.swapmax * self.usdc_to_a2)
    ...
    def set_baseline(self, a1toa2, a2toa1):
        self.a1toa2_baseline = a1toa2
        self.a2toa1_baseline = a2toa1
